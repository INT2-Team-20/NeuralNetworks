...
class NeuralN(nn.Module):
    def __init__(self):
        super().__init__()
        self.Linear1 = nn.Linear(121800, 2048)
        self.Linear2 = nn.Linear(2048, 102)
        self.Dropout = nn.Dropout(0.003)
        self.Conv1 = nn.Conv2d(3, 200, 8, 1)
        self.Conv2 = nn.Conv2d(200, 400, 8, 1)
        self.Conv3 = nn.Conv2d(400, 600, 8, 1)
